...
int main(void)
{
  ...
  /* USER CODE END WHILE */
		...
		if(HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_7) == GPIO_PIN_SET )
		{
			...
			printf("Flame Sensor no detected!\r\n");
			
		}
		else
		{
			HAL_GPIO_WritePin(LED1_GPIO_Port, LED1_Pin,GPIO_PIN_SET );
			printf("Flame Sensor detected\r\n");				
